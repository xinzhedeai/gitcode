		...
		if ( result!= null) {
			...
			if(rows != null){
				for(var i=0;i<rows.length;i++){
					...
					p += '<i  class="fa fa-lg fa-thumbs-o-up  noSoluted'+rows[i].REQUEST_REPLY_ID+'" style="display:' + noSolutedStyle + ';" onclick="confirmSoluted(\''+rows[i].REQUEST_REPLY_ID+'\');"></i>';
					p += '<i  class="fa fa-lg fa-thumbs-up soluted'+rows[i].REQUEST_REPLY_ID+'" style="display:' + solutedStyle + ';"></i>';
